...
public class Direct_Control_BD {
    ...
    /**
     * Obtiene el valor del inputfileventario segun el nombre del inputfileventario La
...
//        try {
//            String verProductosAgotados = this.readSql("/"
//                    + "sql_files/"
...
//    }
 ...
 El resultado es el sig: Fecha, Descripcion , Monto
    ...
    /**
     * Recibe un arreglo con todos los atributos necesarios para inputfilegresar un
 producto que pertenece a un inputfileventario especifico La fecha que esta por
 default es la del dia
    ...
    public void crearProducto(String idProducto, String nombre, BigDecimal precio,
        ...
        try {
            String CrearProducto = this.readSql("/"
    ...
    /**
     * Insertar productos en el inputfileventario
     *
     * @param idProducto
    ...
    public void insertarEnInventario(String idProducto, int idUbicacionProducto,
        ...
        try {
            String insertarProductoEnInventario = this.readSql("/"
    ...
    public void verFacturasPendientes() {//Bueno+
        try {
            String VerFacturasPendientes = readSql("/"
    ...
    public void verApartadosPendientes() {//Bueno+
        try {
            String VerApartadosPen = readSql("/"
    ...
    public void verCreditosPendientes() {//Bueno+
        try {
            String VerCreditosPendientes = readSql("/"
    ...
    public void VentasProductoPorCategoriaFecha(int categoria,
        ...
        try {
            String ventasProductoPorCategoria = this.readSql("/"
    ...
    public void crearFactura(int idFactura, BigDecimal descuento, int idCliente,
        ...
        try {
            String CrearFactura = this.readSql("/"
    ...
    public void consultarCategorias() {
        try {
            String categorias = this.readSql("/"
    ...
    public void consultarProducto(String idProducto) {
        try {
            String valorInventario = readSql("/"
    ...
    private String readSql(String filePath) throws IOException {
        InputStream inputfile = Direct_Control_BD.class.getClass().getResourceAsStream(filePath);
        StringBuilder sb;
    ...
    public void cantidadDeProductos() {//esta bien
        try {
            String CantidadProductos = this.readSql("/sql_files/CantidadDeProductos.sql");
    ...
    /**
     * Esta consulta retorna la lista de precios del inputfileventario seleccionado
...
//esta bien
        try {
            ...
            String listaDePrecios = this.readSql("/sql_files/"
 ...
 de una ubicacion del inputfileventario(Bodega o General)
     *
     * @param categoria
    ...
    public void verProductosPorCategoriaDeUnInv(String categoria,
        ...
        try {
            ...
            String productosPorCategoria = this.readSql("/sql_files/ProductosPorCategoriaDeUnInventario.sql");
    ...
    /**
     * Esta consulta obtiene todos los productos del inputfileventario seleccionado
 (Bodega o General) que no pertenecen a ninputfileguna categoria.
     *
     * @param descripcionDeUnInv
     */
    public void verProductosSinCategoriaDeUnInv(String lugarDeUnInv) {//estabien
        try {
            ...
            String productosSinCategoria = this.readSql("/sql_files/ProductosSinCategoria.sql");
            PreparedStatement stm
    ...
    /**
     * Esta Consulta Obtiene el movimiento de un producto por el terminputfileo de
 facturacion. Se le debe proporcionar el lugar del inputfileventario (Bodega o
 General) y la fecha de rango de busqueda.
    ...
    public void verMovProductosFacturados(String lugarDeUnInv, String fechaInicio, String fechaFinal) {//esta bien
        try {
            ...
            String verMovProductosFacturados = this.readSql("/sql_files/MovProductoFacturado.sql");
            PreparedStatement stm
    ...
    public void verMovProductosOrdenadosPorTipo(String lugarDeUnInv, String fechaInicio, String fechaFinal) {//esta bien
        try {
            ...
            String verMovProductosFacturadosPorTipo = this.readSql("/sql_files/MovProductosPorTipo.sql");
            PreparedStatement stm
    ...
    public void verMovimientos() {//esta bien
        try {
            ...
            String verMovProductoOrdenadoPorTipo = this.readSql("/sql_files/verMovimientos.sql");
            PreparedStatement stm
    ...
    public void verMovProductoOrdenadoPorTipo(String idProducto,
        ...
        try {
            ...
            String verMovProductoOrdenadoPorTipo = this.readSql("/sql_files/MovProductoPorTipo.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(verMovProductoOrdenadoPorTipo);
            stm.setString(1, idProducto);
    ...
    public void actualizarCantidadProductoInventario(int CantidadNueva, String idProducto, int idLugarMovimiento) {//esta bien
        try {
            String ModificarProducto = this.readSql("/sql_files/actualizarCantidadProductoInventario.sql");
            PreparedStatement stm
    ...
    public void modificarProducto(String idProducto, String nombre,
        ...
        try {
            String ModificarProducto = this.readSql("/sql_files/ModificarProducto.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(ModificarProducto);
    ...
    public void modificarProducto(String idProducto, String nombre,
        ...
        try {
            String ModificarProducto = this.readSql("/sql_files/ModificarProducto2.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(ModificarProducto);
            stm.setString(1, nombre);
    ...
    public void BuscarCategoriaPorDescripcion(String descripcionDeCategoria) {
        try {
            ...
            String BuscarCategoriaPorDescripcion = this.readSql("/sql_files/BuscarCategoriaPorDescripcion.sql");
            PreparedStatement stm
    ...
    public void ventasPorVendedorCancelada(String FechaIni, String FechaFin,
        ...
        try {
            ...
            String ventasPorVend = this.readSql("/sql_files/VentasPorVendedorCancelada.sql");
            PreparedStatement stm
    ...
    public void ventasPorVendedorAparatadoOCredito(String FechaIni, String FechaFin,
        ...
        try {
            ...
            String ventasPorVend = this.readSql("/sql_files/VentasPorVendedorAparatadoOCredito.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(ventasPorVend);
            stm.setString(1, NombreVendedor);
            stm.setString(2, FechaIni);
    ...
    public int insertarDevoluciones(String Fecha, String TipoPago, int TotalFacturado, int idCliente, int idVendedor, String Nota) {
        try {
            String devolucion = this.readSql("/sql_files/"
    ...
    public void eliminarProducto(String idProducto) {
        try {
            String eliminar = this.readSql("/sql_files/"
    ...
    public void crearCierreDeCaja(String FechaInicio, String FechaFinal, int Cajero, String NombreCaja, String Observaciones, int ReporteInicial) {
        ...
        try {
            String devolucion;
            try {
                devolucion = this.readSql("/sql_files/"
    ...
    public String consultarNombreCategoriaXid(int idCategoria) {
        try {
            ...
            String BuscarCategoriaPorDescripcion = this.readSql("/sql_files/consultarNombreCategoriaXId.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(BuscarCategoriaPorDescripcion);
    ...
    public int consultarIdCategoriaXNombre(String Nombre) {
        try {
            ...
            String BuscarCategoriaPorDescripcion = this.readSql("/sql_files/consultarIdCategoriaXNombre.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(BuscarCategoriaPorDescripcion);
            stm.setString(1, Nombre);
            ResultSet rs = stm.executeQuery();
    ...
    public int consultarCantidadDeunProducto(String idProducto) {
        try {
            ...
            String BuscarCategoriaPorDescripcion = this.readSql("/sql_files/consultarCantidadDeunProducto.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(BuscarCategoriaPorDescripcion);
            stm.setString(1, idProducto);
            ResultSet rs = stm.executeQuery();
    ...
    public int consultarIdLugarXNombre(String nombreLugar) {
        try {
            ...
            String BuscarCategoriaPorDescripcion = this.readSql("/sql_files/consultarIdLugarXNombre.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(BuscarCategoriaPorDescripcion);
    ...
    public int consultarVentasXTipoPagoYFecha(String FechaInicio, String FechaFinal, String TipoPago) {
        try {
            ...
            String BuscarCategoriaPorDescripcion = this.readSql("/sql_files/consultarVentasXTipoDePagoXFecha.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(BuscarCategoriaPorDescripcion);
    ...
    /**
     * Permite inputfilesertar una factura pendiente.
     *
     * @param idFactura
     * @param saldo
    ...
    public void insertarFacturasPendientes(int idFactura, BigDecimal saldo, String fechaVencimiento, int idVersionFactPendientes) {
        try {
            String insertarFacturasPendientes = this.readSql("/sql_files/"
    ...
    /**
     * Permite inputfilesertar un pago en una factura pendiente.
     *
     * @param fecha
     * @param montoDePago
    ...
    public void insertarPago(BigDecimal PagoTarjeta, BigDecimal PagoContado, int idFacturaPendiente, int idFacturaVersionPagosPend) {
        try {
            ...
            Date date = new Date();
            String fecha = dateFormat.format(date);
            String insertarPago = this.readSql("/sql_files/"
                    + "insertarPago.sql");
    ...
    /**
     * Obtiene la inputfileformacion de las ultimas 100 facturas.
     */
    public void verFacturas() {
        try {
            String verFacts = this.readSql("/sql_files/"
                    + "VerFacturas.sql");
    ...
    /**
     * Obtiene la inputfileformacion de las ultimos 1000 apartados.
     */
    ...
    public void verInventario() {
        try {
            String verInventario = this.readSql("/sql_files/"
    ...
    public String verDescripcion(String codigo) {
        try {
            String verDescripcion = this.readSql("/sql_files/verDescripcionPorCodigo.sql");
            PreparedStatement stm
    ...
    public BigDecimal verPrecio(String codigo) {
        ...
        try {
            String verDescripcion = this.readSql("/sql_files/verPrecioPorCodigo.sql");
            PreparedStatement stm
                    = this.conection.prepareStatement(verDescripcion);
            stm.setString(1, codigo);
            ResultSet rs = stm.executeQuery();
    ...
    public void verCodigos() {
        try {
            String verCodigos = this.readSql("/sql_files/verCodigos.sql");
    ...
    public void verLugares() {
        try {
            String verCodigos = this.readSql("/sql_files/consultarLugares.sql");
            ResultSet rs = statement.executeQuery(verCodigos);
            this.setColumnNames(this.Get_Columnas(rs));
            this.setData(this.ResultSet_Array(rs));
        } catch (Exception e) {
    ...
    public int ObtenerUltimoidFact() {
        int result = 0;
        try {
            String valorInventario = this.readSql("/sql_files/ObtenerUltimoidFact.sql");
            PreparedStatement stm = this.conection.prepareStatement(valorInventario);
            ResultSet resultset = stm.executeQuery();
            //Imprime el resultado obtenido del valor del inventario
            while (resultset.next()) {
    ...
    public String verNombre(String codigo) {
        try {
            String verNombre = this.readSql("/sql_files/verNombrePorCodigo.sql");
            PreparedStatement stm
    ...
    public void insertarCategoria(String Nombre) {
        try {
            String categoria = this.readSql("/sql_files/"
                    + "crearCategoria.sql");
    ...
    /**
     * Esta consulta da la cantidad del inputfilevetario(General) de un producto
 seleccionado
     *
     * @param idProducto
     * @return
    ...
    public int verCantidadInvGeneral(String idProducto) {
        int cantidad = 0;
        try {
            String verCantidad = this.readSql("/sql_files/verCantidadPorCodigo.sql");
    ...
    public boolean verSiExisteCod(String idProducto) {
        try {
            String verCantidad = this.readSql("/sql_files/verSiExisteCod.sql");
            PreparedStatement stm = this.conection.prepareStatement(verCantidad);
            stm.setString(1, idProducto);
            ResultSet rs = stm.executeQuery();
            return rs.next();
    ...
    public int veridVersionActivaProductoPorCodigo(String codigo) {
        try {
            String verVersion = this.readSql("/sql_files/verVersionPorCodigo.sql");
            PreparedStatement stm
    ...
    public void VerFacturasCanceladasPorRangoDeFecha(String FechaIni,
            String FechaFin) {
        try {
            String Fact = this.readSql("/sql_files/VerFacturasCanceladasPorRangoDeFecha.sql");
    ...
    public void VerFacturasPorRangoDeFecha(String FechaIni,
            String FechaFin) {
        try {
            String Fact = this.readSql("/sql_files/VerFacturasRangoDeFecha.sql");
            PreparedStatement stm = this.conection.prepareStatement(Fact);
            stm.setString(1, FechaIni);
            stm.setString(2, FechaFin);
    ...
    /**
     * Permite la inputfilesercion de un producto en la factura.
     *
     * @param idProducto
     * @param idVersion
     * @param Cantidad
    ...
    public void insertarProductoCantidadFact(String idProducto, int idVersion, int Cantidad, int idFactura, BigDecimal PrecioVenta, int idVersionFacturasProducto) {
        try {
            String insertarProductoCantFact = this.readSql("/sql_files/"
    ...
    public void VerFacturasPoridProducto(String FechaIni, String FechaFin, String idProducto) {
        try {
            String Fact = this.readSql("/sql_files/VentasPorRangoFechYidProd.sql");// hacer consulta por prod
            PreparedStatement stm = this.conection.prepareStatement(Fact);
            stm.setString(1, idProducto);
            stm.setString(2, FechaIni);
            stm.setString(3, FechaFin);
    ...
    public void FacturasPorCategoriaDeProd(String FechaIni, String FechaFin, String categoria) {
        try {
            ...
            String Fact = readSql("/sql_files/FacturasPorCategoriaDeProd.sql");// hacer consulta por prod
            PreparedStatement stm = this.conection.prepareStatement(Fact);
            stm.setString(1, categoria);
            stm.setString(2, FechaIni);
            stm.setString(3, FechaFin);
    ...
    public void verVendedores() {
        try {
            String consultarVendedores = this.readSql("/sql_files/consultarVendedores.sql");
    ...
    /**
     * Obtener inputfileformacion de Clientes
     */
    public void consultarClientes() {
        try {
            String clientes = this.readSql("/"
    ...
    /**
     * Retorna inputfileformacion de una persona, dado un nombre
     *
     * @param nombre
     */
    public void consultarPersona(String nombre) {
        try {
            String infoPersona = this.readSql("/"
...
//    }
    ...
    public int veridVendedor(String vendedor) {
        try {
            String verIdVendedor = this.readSql("/sql_files/verIdVendedor.sql");
            PreparedStatement stm
    ...
    public boolean verSiExisteCliente(String nombre) {
        try {
            String verCliente = this.readSql("/sql_files/verSiExisteCliente.sql");
    ...
    public void insertarCliente(String nombre, String direccion, String telefono, String FechaCumpleanos) {
        try {
            String crearCliente = this.readSql("/sql_files/"
                    + "crearCliente.sql");
    ...
    public int veridCliente(String cliente) {
        try {
            String verIdCliente = this.readSql("/sql_files/verIdCliente.sql");
            PreparedStatement stm
    ...
    /**
     * Devuelve toda la inputfileformacion(Cliente,Vendedor,Total etc) del num de
 factura inputfilegresado.
     */
    public void verInfoFactura(int NumFact) {
        try {
            String verInfoFactura = this.readSql("/"
    ...
    /**
     * Devuelve toda la inputfileformacion(Cliente,Vendedor,Total etc) del num de
 apartado o credito inputfilegresado.
     */
    public void verInfoApartadoCredito(int NumFact) {
        try {
            String verInfoApartadoCredito = this.readSql("/"
    ...
    public void CosultarFacturasPendientes(String FechaIni, String FechaFin) {
        try {
            String cosultarFacturasPendientes = this.readSql("/sql_files/CosultarFacturasPendientes.sql");
            PreparedStatement stm
    ...
    /**
     * Retorna el inputfilegreso pot terminputfileo de tarjeta
     *
     * @param FechaIni
     * @param FechaFin
     * @param termino
    ...
    public int IngresosPorTarjPorFecha(String FechaIni, String FechaFin) {
        try {
            String cosultarFacturasPorTermino = readSql("/src/sql_files/IngresoPorTarjetaPorFecha.sql");
            PreparedStatement stm
    ...
    /**
     * Retorna el inputfilegreso por terminputfileo efectivo por fecha
     *
     * @param FechaIni
     * @param FechaFin
     */
    public int IngresosPorEfectivoPorFecha(String FechaIni, String FechaFin) {
        try {
            String cosultarFacturasPorTermino = readSql("/sql_files/IngresoPorEfectivoPorFecha.sql");
            PreparedStatement stm
                    = conection.prepareStatement(cosultarFacturasPorTermino);
            stm.setString(1, FechaIni);
            stm.setString(2, FechaFin);
    ...
    /**
     * Devuelve todos los productos de una factura determinputfileada.
     */
    public void verProductosPorFactura(int NumFact) {
        try {
            String verProductosPorFactura = this.readSql("/"
    ...
    /**
     * 'Eliminputfilea'(Cambia de estado a eliminputfileada) el numero de factura seleccionado
     *
     * @param NumFact
     */
    ...
    public void VentasDeProductosPorVendedor(String FechaIni, String FechaFin,
            String Vendedor) {
        try {
            String ventasDeProductosPorVendedor = readSql("/sql_files/VentasDeProductosPorVendedor.sql");
            PreparedStatement stm
    ...
    public void VentasDeProductosPorCliente(String FechaIni, String FechaFin,
        ...
        System.out.println(Cliente);
        try {
            String ventasDeProductosPorCliente = readSql("/sql_files/VentasDeProductosPorCliente.sql");
            PreparedStatement stm
    ...
    public int verVersionDEFacturaActiva(int idFactura) {
        try {
            String verVersionDEFacturaNueva = this.readSql("/sql_files/verVersionFacturaNueva.sql");
            PreparedStatement stm
    ...
    /**
     * Eliminputfilea la factura que se modifico(la vuelve inputfileactiva para poder luego
 ver cuales fueron las modificaciones que se le hicieron a la factura)
    ...
    public void eliminarFacturaPorModificacion(int NumFact) {
        try {
            String eliminarFacturaPorModf = this.readSql("/sql_files/"
    ...
    public void actualizarCantidadInventario(String codArticulo, int cantidad) {
        try {
            String actualizarCantidadInv = this.readSql("/sql_files/actualizarCantidadInventario.sql");
            PreparedStatement stm
    ...
    /**
     * permite obtener las facturas que fueron eliminputfileadas
     *
     * @param FechaIni
     * @param FechaFin
     */
    public void VerFacturasEliminadas(String FechaIni, String FechaFin) {
        try {
            String Fact = this.readSql("/sql_files/VerFacturasEliminadas.sql");
            PreparedStatement stm = this.conection.prepareStatement(Fact);
            stm.setString(1, FechaIni);
            stm.setString(2, FechaFin);
            stm.setString(3, FechaIni);
...
//        try {
//            String idFacturas = this.readSql("/src/sql_files/ObtenerIdFactModificadas.sql");
...
//    }
    ...
    public void ObtenerFacturaModificadaYSusVersiones(String idFactura) {
        try {
            String Facturas = this.readSql("/sql_files/ObtenerFacturasModificadas.sql");
    ...
    public void ObtenerDevolucionesModificadaYSusVersiones(String idDev) {
        try {
            String Facturas = this.readSql("/sql_files/ObtenerDevolucionesModificadaYSusVersiones.sql");
            PreparedStatement stm = this.conection.prepareStatement(Facturas);
    ...
    public void verProductosPorFacturaYVersionDeFactura(String idFact,
            int version) {
        try {
            String verProductosPorFacturaYVersion = this.readSql("/"
    ...
    /**
     * Obtener inputfileformacion de productos dado un nombre
     *
     * @param Inic
     * @param hasta
     */
    ...
    /**
     * Obtener inputfileformacion de productos dado una categoria
     *
     * @param categoria
     */
    ...
    public void verInfoFacturaApartado(int NumFact) {
        try {
            String verInfoFacturaApartado = this.readSql("/"
    ...
    public void ObtenerFactModificadaOriginales() {
        try {
            String verInfoFacturaApartadoPagos = this.readSql("/"
    ...
    /**
     * Permite Ver Productos en inputfileventario Por Rango de Codigo
     *
     * @param Inic
     * @param hasta
     * @param ubicacion
    ...
    /**
     * Permite Ver Productos en inputfileventario Por Rango de Nombre
     *
     * @param Inic
     * @param hasta
     * @param ubicacion
    ...
    /**
     * Permite Ver Productos en inputfileventario Por Categoria
     *
     * @param categoria
     * @param ubicacion
     */
 ...
 el NumFact inputfilegresado
    ...
    public void verInfoFacturaCredito(int NumFact) {
        ...
        try {
            String verInfoFacturaCredito = this.readSql("/"
    ...
    public void verDevoluciones() {
        try {
            String verDevs = this.readSql("/sql_files/"
                    + "VerDevoluciones.sql");
    ...
    public void crearDevolucion(int idFactura, BigDecimal descuento, int idCliente, int idVendedor, String concepto, String detalle, BigDecimal totalFact, String estado) {
        ...
        try {
            String CrearDevolucion = this.readSql("/"
    ...
    public void insertarProductoCantidadDev(String idProducto, int idVersion, int cantidad, int idFactura, BigDecimal PrecioVenta, int idVersionFacturasProducto) {
        try {
            String insertarProductoCantDev = this.readSql("/sql_files/"
                    + "insertarProductoCantidadDev.sql");
    ...
    public int verVersionDEDevolucionActiva(int idDev) {
        try {
            String verVersionDEDevNueva = this.readSql("/sql_files/verVersionDevNueva.sql");
            PreparedStatement stm
    ...
    /**
     * Devuelve todos los productos de una devolucion determinputfileada.
     */
    public void verProductosPorDevolucion(int NumFact) {
        try {
            String verProductosPorDevolucion = this.readSql("/"
    ...
    public int ObtenerUltimoidDev() {
        int result = 0;
        try {
            String ultimoIdDev = this.readSql("/sql_files/ObtenerUltimoidDev.sql");
    ...
    public void verInfoDevolucion(int NumDev) {
        try {
            String verInfoDev = this.readSql("/"
    ...
    /**
     * Eliminputfilea la devolucion que se modifico(la vuelve inputfileactiva para poder luego
 ver cuales fueron las modificaciones que se le hicieron a la devolucion)
    ...
    public void eliminarDevolucionPorModificacion(int NumDev) {
        try {
            String eliminarDevPorModf = this.readSql("/sql_files/"
    ...
    /**
     * 'Eliminputfilea'(Cambia de estado a eliminputfileada) el numero de devolucion
 seleccionado
     *
     * @param NumDev
     */
    ...
    public void VerDevolucionesPorRangoDeFecha(String FechaIni, String FechaFin) {
        try {
            String Dev = this.readSql("/sql_files/VerDevolucionesPorRangoDeFecha.sql");
    ...
    public void VerDevolucionesEliminadas(String FechaIni, String FechaFin) {
        try {
            String Fact = this.readSql("/sql_files/VerDevolucionesEliminadas.sql");
            PreparedStatement stm = this.conection.prepareStatement(Fact);
            stm.setString(1, FechaIni);
            stm.setString(2, FechaFin);
            ResultSet rs = stm.executeQuery();
    ...
    public void verCierreFacturasContado(String fechaInicio, String fechaFinal) {
        try {
            String verFactContadoParaCierre = this.readSql("/"
    ...
    public int obtenerultimoidCierre() {
        int result = 0;
        try {
            String ultimoIDCierre = this.readSql("/sql_files/ObtenerUltimoidCierre.sql");
    ...
    public String obtenerFechaInicioCierre(int idCierreVigente) {
        String result = "";
        try {
            String HoraInicioCierre = this.readSql("/sql_files/ObtenerHoraInicioCierre.sql");
    ...
    public void verCierreApartadosCreditos(String fechaInicio, String fechaFinal) {
        try {
            String verCierreApartadosCreditos = this.readSql("/"
    ...
    public void verCierreDevoluciones(String fechaInicio, String fechaFinal) {
        try {
            String verCierreDevoluciones = this.readSql("/"
    ...
    public String obtenerCajeroCierre(int idCierreVigente) {
        String result = "";
        try {
            String Cajero = this.readSql("/sql_files/ObtenerCajeroCierre.sql");
    ...
    public BigDecimal obtenerMontoInicio(int idCierreVigente) {
        ...
        try {
            String MontoInicio = this.readSql("/sql_files/ObtenerMontoInicioCierre.sql");
    ...
    public void actualizarCierreDeCaja(String HoraCierre,
        ...
        try {
            String ActualizarCierreCaja = this.readSql("/sql_files/actualizarCierreCaja.sql");
            PreparedStatement stm
    ...
    public void verCierres() {
        try {
            String verCierres = this.readSql("/sql_files/"
                    + "verCierres.sql");
    ...
    public void obtenerInfoCierre(int idCierre) {
        ...
        try {
            String ObtenerInfoCierre = this.readSql("/sql_files/ObtenerInfoCierre.sql");
    ...
    public boolean verificarFacturaCierre(String fechaInicio, int idFact) {
        ...
        String fecha = dateFormat.format(date);
        try {
            String verSiModEliminaFactura = this.readSql("/sql_files/verSiModElimFactura.sql");
    ...
    public boolean verificarDevCierre(String fechaInicio, int idDev) {
        ...
        String fecha = dateFormat.format(date);
        try {
            String verSiModEliminaDev = this.readSql("/sql_files/verSiModElimDevolucion.sql");
    ...
    public void consultarAdministradores() {
        try {
            String administradores = this.readSql("/"
    ...
    public int ObtenerUltimoidMovimiento() {
        int result = 0;
        try {
            String verUltimoIdMov = this.readSql("/sql_files/ObtenerUltimoidMovimiento.sql");
    ...
    public void insertarIdCliente(int idCliente) {
        try {
            String insertarIdCliente = this.readSql("/sql_files/crearIdCliente.sql");
    ...
    public int verCantidadBodega(String idProducto) {
        int cantidad = 0;
        try {
            String verCantidad = this.readSql("/sql_files/verCantidadPorCod_Bodega.sql");
            PreparedStatement stm = this.conection.prepareStatement(verCantidad);
            stm.setString(1, idProducto);
            ResultSet rs = stm.executeQuery();
            while (rs.next()) {
    ...
    public void verEntradasMercaderia() {
        try {
            String VerEntradasMercaderia = readSql("/"
    ...
    public void eliminarUsuario(String usuario, String tipoUsuario) {
        try {
            String Usuario = this.readSql("/sql_files/eliminarUsuario.sql");
    ...
    public boolean insertarPersona(String nombre, String direccion,
        ...
        try {
            String PersonaUsuario = this.readSql("/sql_files/CrearPersona.sql");
            PreparedStatement stm = this.conection.
    ...
    public void modificarUsuario(String nombre, String direccion,
        ...
        try {
            String PersonaUsuario = this.readSql("/sql_files/modificarUsuario.sql");
            PreparedStatement stm = this.conection.
                    prepareStatement(PersonaUsuario);
    ...
    public void insertarUsuario(String tipoUsuario, String clave) {
        try {
            String Usuario = this.readSql("/sql_files/InsertarUsuario.sql");
            PreparedStatement stm = this.conection.prepareStatement(Usuario);
    ...
    public void ConsultarContrasena(String usuario, String tipoUsuario) {
        try {
            String Usuario = this.readSql("/sql_files/ConsultarUsuario.sql");
            PreparedStatement stm = this.conection.prepareStatement(Usuario);
            stm.setString(1, tipoUsuario);
    ...
    public void actualizarPrecioProducto(String idProducto, BigDecimal precio) {
        try {
            String actualizarPrecio = this.readSql("/sql_files/actualizarPrecioProductoInventario.sql");
            PreparedStatement stm
    ...
    public void eliminarProductosQueNoTienenInventario() {
        try {
            String eliminaProductos = this.readSql("/sql_files/eliminaProductosSinINV.sql");
    ...
    public void verInfoMovimiento(int NumMovimiento) {
        try {
            String verInfoMovimiento = this.readSql("/"
    ...
    public void verSalidasMercaderia() {
        try {
            String verSalidasMercaderia = readSql("/"
    ...
    public void VerMovimientosPorFechaYLugar(String tipo, String lugar, String fechaIni, String fechaFin) {
        try {
            ...
            String movimientos = readSql("/sql_files/VerMovimientosPorFechaYLugar.sql");
    ...
    public void eliminarMovimiento(String detalle) {
        try {
            String eliminaMov = this.readSql("/sql_files/eliminarMovimiento.sql");
    ...
    public void verBodega() {
        try {
            String verBodega = this.readSql("/sql_files/"
                    + "consultarBodega.sql");
    ...
    /**
     * Este metodo convierte un strinputfileg que es un decimal a bigdecimal
     *
     * @param numero
     * @return
     */
    ...
    public void VerProductosAgotadosPorUbicacion(String ubicacion) {
        try {
            String ProductosAgotados = this.readSql("/"
 ...
 adminputfileistrador Retorna 2 si el usuario es vendedor
     *
     * @param nombreUsuario
     * @param contrasena
     * @return
    ...
    public String obtenerTipoUsuario(String nombre) {
        try {
            String verTipoUsuario = this.readSql("/sql_files/obtenerTipoUsuario.sql");
    ...
    public boolean verSiExisteCierreTerminado(int idCierre) {
        ...
        try {
            String temp = "";
            String verSiExisteCierreTerminado = this.readSql("/sql_files/verSiExisteCierreTerminado.sql");
    ...
    public void VerFacturasCredOApartPorRangoDeFecha(String FechaIni, String FechaFin, String concepto) {
        try {
            String Fact = this.readSql("/sql_files/VerFacturasCredOApartPorRangoDeFecha.sql");
            PreparedStatement stm = this.conection.prepareStatement(Fact);
            stm.setString(1, FechaIni);
            stm.setString(2, FechaFin);
    ...
    /**
     * Retorna los inputfilegresos ocurridos en un rango de fecha
     *
     * @param FechaIni
     * @param FechaFin
     * @return
    ...
    public int egresoTotalPorDevolucionesRangoFecha(String FechaIni, String FechaFin) {
        try {
            ...
            String valor = this.readSql("/sql_files/ingresoPorDevoluciones.sql");
    ...
    private int ingresoTotalPorApartadoRangoFecha(String FechaIni, String FechaFin) {
        try {
            ...
            String valor = this.readSql("/sql_files/ingresoPorApartado.sql");
            PreparedStatement stm = this.conection.prepareStatement(valor);
            stm.setString(1, FechaIni);
            stm.setString(2, FechaFin);
            ResultSet resultset = stm.executeQuery();
    ...
    private int ingresoTotalPorCreditoRangoFecha(String FechaIni, String FechaFin) {
        try {
            ...
            String valor = this.readSql("/sql_files/ingresoPorCredito.sql");
            PreparedStatement stm = this.conection.prepareStatement(valor);
            stm.setString(1, FechaIni);
            stm.setString(2, FechaFin);
            ResultSet resultset = stm.executeQuery();
    ...
    private int ingresoTotalPorCanceladaRangoFecha(String FechaIni, String FechaFin) {
        try {
            ...
            String valor = this.readSql("/sql_files/ingresoPorContado.sql");
            PreparedStatement stm = this.conection.prepareStatement(valor);
            stm.setString(1, FechaIni);
            stm.setString(2, FechaFin);
            ResultSet resultset = stm.executeQuery();
    ...
    public boolean versiExisteCategoria(String categoria) {
          try {
            String verCategoria = this.readSql("/sql_files/verSiExisteCategoria.sql");
    ...
    public void actualizarCategoriaProducto(String idProducto, String categoria) {
         try {
            String actualizarCategoria = this.readSql("/sql_files/actualizarCategoriaInventario.sql");
            PreparedStatement stm
