...
public class Pan_VerFactura extends javax.swing.JPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, 43, 30));
        ...
        add(jFormattedTextField_Cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 5, 290, 22));
    ...
    private void bttPrintMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bttPrintMouseClicked
        if (!_savePress){
            ...
            this.imprimir(this.jLabel_NumerodeFact.getText(),this.jLabel_Fecha.getText(),this.jFormattedTextField_Total.getText(),this.jFormattedTextField_SubTotal.getText(),this.jFormattedTextField_desc.getText(),this.jFormattedTextField_DescuentoTotal.getText(),this.jFormattedTextField_Cliente.getText(),
                this.jTextField_Vendedor.getText());
        } 
        _savePress = false;
 ...
 /**
    ...
    public void personalizarTablaVerFactura() {
        this.personalizarTablaVer();
        this.cargarInfoFact();
        this.cargarProductosFact();
        Modelo_verFacturas model = (Modelo_verFacturas) this.jTable_Factura.getModel();
        //Agrega 20 filas
        model.addRow(20);
     ...
     /**
     * Este metodo permite personalizar la tabla de ver Apartado o Credito
     */
    public void personalizarTablaVerApartadoCredito() {
        this.personalizarTablaVer();
        this.cargarInfoApartadoCredito();
        this.cargarProductosFact();
        Modelo_verFacturas model = (Modelo_verFacturas) this.jTable_Factura.getModel();
        //Agrega 20 filas
        model.addRow(20);
...
/**
    ...
    private void cargarInfoFact() {
     ...
     /**
     * Este metodo carga la informacion de un credito o apartado que se desea ver, esta
     * informacion es: cliente,vendedor,totalfact,descuento,fecha,detalle,
     * tipo de pago etc.
     */
    private void cargarInfoApartadoCredito() {
        Direct_Control_BD AdminBD = Direct_Control_BD.getInstance();
    ...
    private void personalizarTablaVer() {
        String[] columnNames = {"Cod. Articulo","Articulo",
            "Cantidad","Precio.Unit",
            "Sub-Total"};
        List<Object[]> data = new ArrayList<Object[]>();      
